...
router.put("/testapitest/:id", async (req, res) => {
  const { id } = req.params;
...
router.delete("/testapi/:id/set_empty", async (req, res) => {
  const { id } = req.params;
...
router.delete("/testapi/:id/:field", async (req, res) => {
...
router.delete("/testapi/:id/photos/:photoId", async (req, res) => {
...
router.delete("/testapi/:id/videos/:videoId", async (req, res) => {
...
router.post("/testapi/:id/addPhotos", async (req, res) => {
  const { id } = req.params;
...
router.post("/testapi/:id/addVideos", async (req, res) => {
  const { id } = req.params;
